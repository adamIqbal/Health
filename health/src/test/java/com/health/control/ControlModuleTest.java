...
public class ControlModuleTest {
    ...
    @Test
    public void setData() {
        // InputData id1 = new InputData("path/to/xml1.xml",
        // "path/to/data1.txt");
        // InputData id2 = new InputData("path/to/xml2.xml",
        // "path/to/data2.txt");
        // InputData id3 = new InputData("path/to/xml3.xml",
        // "path/to/data3.txt");
        //
    ...
    public void setScript() {
        ...
        // String expected =
        // "hist('histogram.png', avgByDay.AvgCreatinine, avgByDay.DateTime.DayOfYear, 365);";
        //
