...
public class TableTest {	
	/**
	 * Tests whether {@link Table#Table(Iterable)} throws a {@link NullPointerException}
	...
	/**
	 * Tests whether {@link Table#Table(Iterable)} throws an {@link IllegalArgumentException}
	 * when given an {@link Iterable} with null elements.
	 */
	...
	/**
	 * Tests whether {@link Table#Table(Iterable)} sets the columns
	 * when given an empty {@link Iterable}
	 * so that {@link Table#getColumns()} returns an {@link Iterable} instance.
	 */
	@Test
	...
	/**
	 * Tests whether {@link Table#Table(Iterable)} sets the columns
	 * when given an {@link Iterable}
	 * so that {@link Table#getColumns()} returns an {@link Iterable} that contains the same elements.
	 */
	@Test
	...
	/**
	 * Tests whether {@link Table#getColumn(String)} returns the right {@link Column}
	...
	public void getColumn_givenNameOfExistingColumn_returnsColumn() {
		...
		Iterable<Column> columns = Arrays.asList(column1, column2, column3, column4);
		Table table = new Table(columns);
	...
	/**
	 * Tests whether {@link Table#getColumn(String)} returns null
	 * when given the name of the column that does not exist.
	 */
	@Test
