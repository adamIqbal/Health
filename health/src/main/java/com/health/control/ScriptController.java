...
/**
 * Controller for the script panel.
 * @author lizzy
 *
 */
public final class ScriptController {
	...
	/**
	 * Create new instance of script controller.
	 * @param scriptP	script panel
	 */
	public ScriptController(final VScriptPanel scriptP) {
		scriptPanel = scriptP;
	}
	...
	public void control() {
		...
		scriptPanel.getSaveScriptButton().addActionListener(
				new ActionListener() {
					@Override
					public void actionPerformed(final ActionEvent arg0) {
						if (scriptPanel.getScriptMainPanel().getScript()
								.equals("")) {
							JOptionPane.showMessageDialog(new JFrame(),
									"You have not typed a script yet.",
							...
							String name = JOptionPane
									.showInputDialog(
											...
											"Save as..");
							String filename = UserInterface.PATH_TO_DATA
									+ "scripts/" + name + ".txt";
							File file = new File(filename);

							try {
								FileUtils.writeStringToFile(file, scriptPanel
										.getScriptMainPanel().getScript());
							} catch (IOException e) {
								JOptionPane.showMessageDialog(new JFrame(),
		...
		scriptPanel.getClearScriptButton().addActionListener(
				new ActionListener() {
					@Override
					public void actionPerformed(final ActionEvent arg0) {
		...
		scriptPanel.getLoadScriptButton().addActionListener(
				new ActionListener() {
					@Override
					public void actionPerformed(final ActionEvent arg0) {
		...
		scriptPanel.getAnalysisButton().addActionListener(
	 ...
	 */
	public void setOutputController(final OutputController controller) {
	 ...
	 */
	public void setInputController(final InputController controller) {
