...
public class GUImain extends JFrame implements UserInterface {
	...
	private void createTabbedPane() {
		...
		VOutputPanel outputPanel = new VOutputPanel();
		...
		OutputController outputController = new OutputController(outputPanel);
	...
	/**
	 * For styling the look and feel of the tabs.
	 * @param from		the from tab
	 * @param to		the to tab
	 */
	public static void selectedTab(final int from, final int to) {
