...
/**
 * A tuple of containing the name of a column and an aggregate function. The aggregate function is
 * optional.
 */
public final class ColumnAggregateTuple {
  ...
  /**
   * Creates a new {@link ColumnAggregateTuple} with the given column and aggregate function.
   *
   * @param column
   *          a column name.
   * @param function
  ...
  /**
   * Gets the modified name of the column to reflect that it contains the result of an aggregate
   * operation. The name remains the same if no aggregate function exists in this tuple.
   *
   ...
   *
   * @return true if this tuple contains an aggregate function; otherwise false.
   */
