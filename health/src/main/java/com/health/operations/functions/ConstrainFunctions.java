...
public final class ConstrainFunctions {
    ...
    public static boolean greater(final Object columns, final Value value) {
        ...
        if (columns instanceof LocalDateTime && value instanceof DateValue) {
            ...
            return ((LocalDateTime) columns).isAfter(((DateValue) value)
                    .getValue());
    ...
    /**
     * Function to determine whether the value gained through table is greater
     * than or equal to value gained through input.
     *
     * @param columns
     *            original value from the column
     * @param value
    ...
    /**
     * Function to determine whether the value gained through table is smaller
     * than or equal to value value gained through input.
     *
     * @param columns
     *            original value from the column
     * @param value
    ...
    public static boolean smaller(final Object columns, final Value value) {
        ...
        if (columns instanceof LocalDateTime && value instanceof DateValue) {
            ...
            return ((LocalDateTime) columns).isBefore(((DateValue) value)
                    .getValue());
    ...
    public static boolean equal(final Object columns, final Value value) {
        ...
        if (columns instanceof LocalDateTime && value instanceof DateValue) {
            ...
            return ((LocalDateTime) columns).isEqual(((DateValue) value)
                    .getValue());
