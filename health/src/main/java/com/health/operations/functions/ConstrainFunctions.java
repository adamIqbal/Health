...
public final class ConstrainFunctions {
  /**
   * Function to determine whether the value gained through input is greater than value in the
   * table.
   *
   * @param columns
  ...
  /**
   * Function to determine whether the value gained through input is greater than or equal to value
   * in the table.
   *
   * @param columns
   *          original value from the column
  ...
  /**
   * Function to determine whether the value gained through input is smaller than or equal to value
   * in the table.
   *
   * @param columns
   *          original value from the column
